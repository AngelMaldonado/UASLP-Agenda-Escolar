  ...
  return (
    ...
    >
      <Card.Body>
        ...
        {hipervinculos()}
        <div
          className="Botones d-flex float-end float-lg-none flex-md-column me-lg-3 justify-content-center align-items-center gap-1"
          onClick={(e) => e.stopPropagation()}>
          <ModalCRUDEvento evento={props.evento}/>
        </div>
      </Card.Body>
