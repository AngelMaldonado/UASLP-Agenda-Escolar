...
import Dropdown  from '../NavbarAgenda/DropDrown';
    ...
    return (  
        <div className=" d-flex justify-content-between p-5">
            ...
            <div className="container">
                ...
                <input name='search' id='search' className="solo black-text" type="search" placeholder="Buscar evento" aria-label="Search" />
